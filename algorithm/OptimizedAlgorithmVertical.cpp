...
#include "OptimizedAlgorithmVertical.h"

#ifdef RUNNING_ON_NOVA
REGISTER_ALGORITHM (OptimizedAlgorithmVertical)
#endif

int OptimizedAlgorithmVertical::getUnloadInstructions(const string &output_path) {
    Errors errors;
    Container container;
...
void OptimizedAlgorithmVertical::moveOrTemporaryUnloadContainer(const string &output_path, string &containerId, int i,
...
void OptimizedAlgorithmVertical::findFirstAvailablePosition(int i, int j, int & targetFloor, int &targetX, int &targetY)  {
...
int OptimizedAlgorithmVertical::getLoadInstructions(const string &input_path, const string &output_path) {
    Errors errors;

...
#ifndef CPP_STOWAGE_OPTIMIZEDALGORITHMHORIZONTAL_H
#define CPP_STOWAGE_OPTIMIZEDALGORITHMHORIZONTAL_H

#include "NaiveAlgorithm.h"

class OptimizedAlgorithmHorizontal : public NaiveAlgorithm{
...
#endif //CPP_STOWAGE_OPTIMIZEDALGORITHMHORIZONTAL_H

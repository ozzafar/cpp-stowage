...
#include "HeuristicOptimized2.h"
#include "../interfaces/AlgorithmRegistration.h"

#ifdef RUNNING_ON_NOVA
REGISTER_ALGORITHM (HeuristicOptimized2)
#endif

int HeuristicOptimized2::getUnloadInstructions(const string &output_path) {
    Errors errors;
    Container container;
...
void HeuristicOptimized2::moveOrTemporaryUnloadContainer(const string &output_path, string &containerId, int i,
...
void HeuristicOptimized2::findFirstAvailablePosition(int i, int j, int & targetFloor, int &targetX, int &targetY)  {
...
int HeuristicOptimized2::getLoadInstructions(const string &input_path, const string &output_path) {
    Errors errors;
...
void HeuristicOptimized2::findNextBestPosition(Container& container, int &nextPositionX, int &nextPositionY) {
    ShipPlan& shipPlan = ship.getShipPlan();
